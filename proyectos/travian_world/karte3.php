...
//die("Por problemas tecnicos, queda suspendido el servicio para el servidor s3.travian.net");
...
<html>
	<head>
		...
		<script type=text/javascript>
			...
			ok3 = "img_t3/ok3.gif";
			*/
			ok1 = "http://s3.travian.net/img/es/b/ok1.gif";
			ok2 = "http://s3.travian.net/img/es/b/ok2.gif";
			ok3 = "http://s3.travian.net/img/es/b/ok3.gif";
	...
	<body bgcolor="#F0F6E9" style="background:#F0F6E9">
			...
			<table align="center" cellspacing="0" cellpadding="3">
				...
				<tr>
					<td><input type="image" value="ok" border="0" name="s1" src="http://s3.travian.net/img/es/b/ok1.gif" width="50" height="20" onMousedown="this.src=ok2" onMouseOver="this.src=ok3" onMouseUp="this.src=ok1" onMouseOut="this.src=ok1"></input></td>
				</tr>
				</form>
			</table>
		</div>
...
Aldeas sin ninguna relacion son dX4.gif (blanco)
Aldeas con las que se tiene PNA son dX5.gif (turquesa)
Aldeas con las que se esta en guerra usan dX2.gif (rojo)
*/
	$left = 0;
	$top = 220;
	for ($i = 0; $i < 13; $i++){
		for ($j = 0; $j < 13; $j++){
			$nuevo_id = id_desp($z, $i - 6, $j - 6);
			if ($data[$nuevo_id]){
				...
				else if (isset($war) && ($aid == $war)) $c = 2;
				else $c = 4;

//				$img = "img_t3/d$h$c.gif";
				$img = "http://s3.travian.net/img/un/m/d$h$c.gif";
			}else{ $img = "http://s3.travian.net/img/un/m/t5.gif"; }
//			}else{ $img = "img_t3/t5.gif"; }
...
?>
		...
		<map name="map2">
			<area href="<?php print $_SERVER["PHP_SELF"]."?z=".(id_desp($z, 1 - $desp, 0)); ?>" coords="200,115,30" shape="circle" title="Norte">
			<area href="<?php print $_SERVER["PHP_SELF"]."?z=".(id_desp($z, 0, $desp - 1)); ?>" coords="762,115,30" shape="circle" title="Este">
			<area href="<?php print $_SERVER["PHP_SELF"]."?z=".(id_desp($z, $desp - 1, 0)); ?>" coords="770,430,30" shape="circle" title="Sur">
			<area href="<?php print $_SERVER["PHP_SELF"]."?z=".(id_desp($z, 0, 1 - $desp)); ?>" coords="210,430,30" shape="circle" title="Oeste">
<?php
...
?>		
		...
		<img style="position:absolute; width:975px; height:550px; z-index:400; left:0px; top:0px;" usemap="#map2" src="http://s3.travian.net/img/un/m/bg_xxl.gif" border="0">
	</body>
</html>
