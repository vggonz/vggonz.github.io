...
*/
	...
	/**
	 * Calcula el desplazamiento en pixeles a partir del 23Âº enlace 
		...
		if (mov_tropas){
			...
			if (a.firstChild.childNodes.length > 0){
				...
				for (var i = 0; i < a.childNodes.length; i++){
					...
					// FIXME: Apaño para FF. Firefox mete nodos vacios
...
FIXME:
	...
	- Mejorar los apaños en el codigo marcados por FIXMEs (14 aprox)
